...
class marcoporolib(object):
    ...
    # fast5
        ...
        self.ontmerg1dstatsH = [
            ...
            ( 'readbp', np.int ),
            ( 'ismapped', np.int ),
            ( 'numalignments', np.int ),
            ( 'numrefcontigs', np.int ),
            ( 'allalnlen', np.int ),
            ( 'allalnreadbp', np.int ),
            ( 'allalnrefbp', np.int ),
            ( 'allalnfreqCperbp', np.float ),
            ( 'allalnfreqMperbp', np.float ),
            ( 'allalnfreqIperbp', np.float ),
            ( 'allalnfreqDperbp', np.float ),
            ( 'allalnpctS', np.float ),
            ( 'allalnpctC', np.float ),
            ( 'allalnpctM', np.float ),
            ( 'allalnpctI', np.float ),
            ( 'allalnpctD', np.float ),
            ( 'allalnmeanrunlenC', np.float ),
            ( 'allalnmeanrunlenM', np.float ),
            ( 'allalnmeanrunlenI', np.float ),
            ( 'allalnmeanrunlenD', np.float ),
            ( 'allalnmeanbq', np.float ),
            ( 'allalnmeanbqC', np.float ),
            ( 'allalnmeanbqM', np.float ),
            ( 'allalnmeanbqI', np.float ),
            ( 'alltargetaligncnt', np.int ),
            ( 'alltargetalignbp', np.int ),
            ( 'allcontrolaligncnt', np.int ),
            ( 'allcontrolalignbp', np.int ),
            ( 'allrandalncnt', np.int ),
            ( 'allrandalncntpct', np.float ),
            ( 'allrandalnbp', np.int ),
            ( 'allrandalnbppct', np.float ),
            ( 'allrandalnmeanbp', np.float ),
            ( 'prialnlen', np.int ),
            ( 'prialnreadbp', np.int ),
            ( 'prialnrefbp', np.int ),
            ( 'prialnfreqCperbp', np.float ),
            ( 'prialnfreqMperbp', np.float ),
            ( 'prialnfreqIperbp', np.float ),
            ( 'prialnfreqDperbp', np.float ),
            ( 'prialnpctS', np.float ),
            ( 'prialnpctC', np.float ),
            ( 'prialnpctM', np.float ),
            ( 'prialnpctI', np.float ),
            ( 'prialnpctD', np.float ),
            ( 'prialnmeanrunlenC', np.float ),
            ( 'prialnmeanrunlenM', np.float ),
            ( 'prialnmeanrunlenI', np.float ),
            ( 'prialnmeanrunlenD', np.float ),
            ( 'prialnmeanbq', np.float ),
            ( 'prialnmeanbqC', np.float ),
            ( 'prialnmeanbqM', np.float ),
            ( 'prialnmeanbqI', np.float ),
            ( 'pritargetaligncnt', np.int ),
            ( 'pritargetalignbp', np.int ),
            ( 'pricontrolaligncnt', np.int ),
            ( 'pricontrolalignbp', np.int ),
            ( 'prirandalncnt', np.int ),
            ( 'prirandalncntpct', np.float ),
            ( 'prirandalnbp', np.int ),
            ( 'prirandalnbppct', np.float ),
            ( 'prirandalnmeanbp', np.float ),
            ( 'prialncnt', np.int )
        ]
        self.ontmerg2dstatsH = [
            ('exptid', 'S20'),
            ('batchid', 'S20'),
            ('runid', 'S200'),
            ('readid', 'S200'),
